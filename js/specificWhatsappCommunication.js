    ...
    d3.xhr("http://localhost:7474/db/data/transaction/commit")
            ...
            .post(
                ...
                if (returnData.results[0].data.length == 0) {
                    alert("Whatsapp Communication: No corresponding result has been returned from database. Please try again.");
                } else {
...
function dataVisualizationWhatsapp(finalResult) {
    ...
    var link = svg.selectAll('.link')
            ...
            .attr("marker-end", function (d) {
                if (d.prop.length > linkFreq_High && d.Type != 'Whatsapp' && d.Type != 'Whatsapp' && d.Type != 'Facebook') {
                    return 'url(#highf)';
                } else if (d.prop.length > linkFreq_Medium && d.Type != 'Whatsapp' && d.Type != 'Whatsapp' && d.Type != 'Facebook') {
                    return 'url(#mediumf)';
                } else if (d.prop.length > linkFreq_Low && d.Type != 'Whatsapp' && d.Type != 'Whatsapp' && d.Type != 'Facebook') {
                    return 'url(#lowf)';
                } else {
                    return "";
                }
